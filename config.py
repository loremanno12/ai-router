...
class Config:
    ...
    # Modello multilingue per italiano: paraphrase-multilingual-MiniLM-L12-v2 (420MB, 384-dim)
    # Supporta italiano nativamente, ideale per prompt utente in italiano.
    # Alternativa inglese-only: BAAI/bge-small-en-v1.5 (130MB, 384-dim)
